...
// GetInitParameters of this Teams
func (tr *Teams) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Teams
func (tr *Teams) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
