...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-mongodbatlas_v1.26.0
...
XPKG_REG_ORGS ?= ghcr.io/mdaops
# NOTE: skip promoting as we're using GHCR
XPKG_REG_ORGS_NO_PROMOTE ?= ghcr.io/mdaops
XPKGS = $(PROJECT_NAME)
...
xpkg.build.provider-atlas-mongodb: do.build.images
...
#   You can check the basic implementation here: https://github.com/crossplane/uptest/blob/main/internal/mongos/03-delete.yaml.tmpl.
